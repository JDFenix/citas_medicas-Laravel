                                            ...
                                            <div id="avatar-container"
                                                ...
                                                <label for="avatarInput" class="avatar-label">
                                                    ...
                                                    <img data-bs-toggle="modal" data-bs-target="#exampleModal"
                                                         ...
                                                         style="background: #5c5c5cbe"
                                                         class="rounded-circle avatar-form"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="d-flex justify-content-center mt-3">
                                                        <button type="submit"
                                                                class="btn btn-success mr-2 me-3">Confirmar
                                                        </button>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                ...
                                <form id="avatar-form" action="" method="post">
                                    <div id="carouselPixelArt" class="carousel carousel-dark slide"
                                            ...
                                            @foreach ($pixelArtUrls as $index => $avatar)
                                                <form action="" method="post" id="form-{{$index}}">
                                                    ...
                                                    <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                                        <img src="{{ $avatar }}" id="avatar-image-option-{{$index}}"
                                        ...
                                        <button class="carousel-control-prev" type="button"
                                                data-bs-target="#carouselPixelArt"
                                                data-bs-slide="prev">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-5 mb-2">
                                <div id="carouselAvataaars" class="carousel carousel-dark slide"
                                     data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                    ...
                                    <button class="carousel-control-prev" type="button"
                                            data-bs-target="#carouselAvataaars"
                                            data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-5">
                                <div id="carouselAdventurer" class="carousel carousel-dark slide"
                                    ...
                                    <button class="carousel-control-prev" type="button"
                                            data-bs-target="#carouselAdventurer"
                                            data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
