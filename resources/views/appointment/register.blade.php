                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-7">
                                    <div class="form-group mt-3">
                                        <label for="clinics_id">Especialidad</label>
                                        <select class="form-select form-control-lg shadow rounded @error('clinics_id') is-invalid @enderror"
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="date" name="date" required
                                            class="form-control form-control-lg shadow rounded @error('date') is-invalid @enderror">
                                        @error('date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="time" id="hour" name="hour" required
                                            class="form-control form-control-lg shadow rounded @error('hour') is-invalid @enderror">
                                        @error('hour')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mt-4 justify-content-center">
                                <div class="col-md-7">
                                    <div class="form-group mt-2">
                                        <label for="doctors_id">Nombre del doctor:</label>
