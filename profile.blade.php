        ...
        <div class="card" style="width: 80%; min-height: 400px;">
            <div class="row no-gutters">
                <div class="col-md-4 d-flex flex-column align-items-center p-3 position-relative">
                    <div id="avatar-container" class="avatar mb-4 position-absolute"
                        style="top: 10px; left: 10px; display: none;">
                        <label for="avatarInput" class="avatar-label">
                            <img src="{{ Auth::user()->avatar }}" alt="Avatar" class="rounded-circle" width="150"
                                height="150">
                        </label>
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center w-100" style="flex-grow: 1;">
                        <div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
                            <button type="button" class="btn btn-outline-secondary mb-2"
                                onclick="changeSection('personal-data')">Datos Personales</button>
                            <button type="button" class="btn btn-outline-secondary mb-2"
                                onclick="changeSection('email')">Email</button>
                            <button type="button" class="btn btn-outline-secondary mb-2"
                                onclick="changeSection('password-auth')">Contraseña y Autenticación</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="login-method" value="Google"
                                                disabled>
                                        </div>
                                    </div>
